	...
	return (
		<MainWrapper>
			<div class="container mx-auto flex flex-col px-5 py-12 justify-center items-center">
				<Image class="lg:w-1/6 md:w-3/6 w-3/6 mb-10 object-cover object-center rounded" alt="hero" />
				<div class="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
					<h6 class="title-font sm:text-4xl text-3xl mb-4 font-small text-gray-900">
						You currently have no projects
					</h6>
					<p class="mb-8 leading-relaxed">Create one and let's the Marathon begin</p>
